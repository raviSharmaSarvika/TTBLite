...
import { TIMELINEEVENTS } from "../../../Utility/constants";
          ...
          <ScrollView>
            <View style={{ flexDirection: "column" }}>
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={{ marginLeft: 10,fontSize:13, paddingRight:20}}> 
        ...
        >
          <View style={styles.subContainer}>
            ...
            <View>
              ...
              <Image
                style={styles.pdfCss}
                source={require("../../../images/HomeScreen/pdfDownload.png")}
              />
            </View>
            <View style={styles.hrLineCss} />
            <ScrollView style={{ height: "100%" }}>
